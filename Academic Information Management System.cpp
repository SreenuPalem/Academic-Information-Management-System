...
void s_login()
{
	...
	/*ifstream i("student.txt",ios::in|ios::binary);
	i.seekg(pos);
...
void w_login()
{
	...
	SetConsoleTextAttribute(h,14);
	nodew *tempw;
	ifstream in("warden.txt",ios::in|ios::binary);
	in.seekg(ios::beg);
	int i;
...
//		cout<<"1-View Profile\n2-Approve leave\n3-View student detail\n4-To change password\n5-Return to main menu\n\nEnter your choice : ";
        ...
        ofstream o("warden.txt",ios::out|ios::binary);
		tempw->z=w;
		tempw=topw;
        while(tempw)
        {
...
class admin
{
	...
	void add_warden(){
		ofstream o("warden.txt",ios::out|ios::binary|ios::app);
		warden w;
		w.get_warden();
		o.write((char*)&w,sizeof(w));
		o.close();
...
int main()
{
	...
	/*	 student ss[2];
		ifstream f("student.txt",ios::in|ios::binary);
		for(int i=0;i<2;++i)
		{
	...
	/* fstream in("faculty.txt",ios::in|ios::binary);
	faculty f;
	in.seekg(ios::beg);
	for(int i=0;i<f_size;i++)
	{
	...
	/* ofstream o("C:\Users\mamid\OneDrive\Desktop\admin.txt",ios::out|ios::binary);
		admin a;
		a.get_admin();
		o.write((char*)&a,sizeof(a));
	o.close(); */ 
	...
	/* ifstream in("C:\Users\mamid\OneDrive\Desktop\admin.txt",ios::in|ios::binary);
	admin a;
	in.seekg(ios::beg);
	in.read((char*)&a,sizeof(a));
	a.print_admin();
